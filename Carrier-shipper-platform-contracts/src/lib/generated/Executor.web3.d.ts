...
export type PayOrderFeePercentInSusdcUpdated = ContractEventLog<{
  newValue: [string];
  0: [string];
}>;
export type payOrderFeeFixedInSusdcUpdated = ContractEventLog<{
  newValue: string;
  0: string;
}>;
...
export interface Executor extends BaseContract {
  ...
  methods: {
    ...
    payOrderFeeFixedInSusdc(): NonPayableTransactionObject<string>;

    payOrderFeePercentInSusdc(): NonPayableTransactionObject<string>;
    ...
    setpayOrderFeeFixedInSusdc(
      newValue: number | string | BN
    ): NonPayableTransactionObject<void>;

    setPayOrderFeePercentInSusdc(
      newValue: [number | string | BN]
    ): NonPayableTransactionObject<void>;
  };
  events: {
    ...
    PayOrderFeePercentInSusdcUpdated(
      cb?: Callback<PayOrderFeePercentInSusdcUpdated>
    ): EventEmitter;
    PayOrderFeePercentInSusdcUpdated(
      options?: EventOptions,
      cb?: Callback<PayOrderFeePercentInSusdcUpdated>
    ...
    payOrderFeeFixedInSusdcUpdated(
      cb?: Callback<payOrderFeeFixedInSusdcUpdated>
    ): EventEmitter;
    payOrderFeeFixedInSusdcUpdated(
      options?: EventOptions,
      cb?: Callback<payOrderFeeFixedInSusdcUpdated>
  ...
  once(
    event: "PayOrderFeePercentInSusdcUpdated",
    cb: Callback<PayOrderFeePercentInSusdcUpdated>
  ): void;
  once(
    event: "PayOrderFeePercentInSusdcUpdated",
  ...
  once(
    event: "payOrderFeeFixedInSusdcUpdated",
    cb: Callback<payOrderFeeFixedInSusdcUpdated>
  ): void;
  once(
    event: "payOrderFeeFixedInSusdcUpdated",
