...
/* Contract Imports */
import { LineAxis } from "./LineAxis.sol";
 ...
 * Runtime target: OVM
 */
contract L2DepositedERC20 is Abs_L2DepositedToken, LineAxis {
    ...
    constructor(
        ...
        uint256 _decimals,
        bool _frozen
    ) Abs_L2DepositedToken(_l2CrossDomainMessenger) LineAxis(_name, _symbol, _decimals, 0, _frozen) {}
